...
{
    Task<IEnumerable<CategoryDB>> GetCategoriesAsync(string? searchTerm = null, int pageNumber = 1, int pageSize = 10, bool trackChanges = false, CancellationToken cancellationToken = default);

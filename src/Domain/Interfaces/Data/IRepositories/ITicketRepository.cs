...
public interface ITicketRepository : IRepositoryBase<Ticket>
{
    ...
    Task<PaginatedResponse<GetTicketDetailsResponse>> GetCheckinsByEventAsync(Guid eventId, int pageNumber, int pageSize, bool trackChanges = false, CancellationToken cancellationToken = default);
}